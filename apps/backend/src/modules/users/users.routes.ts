...
import { updateProfileSchema, updatePreferencesSchema, changePasswordSchema } from './users.validation.js';
...
usersRoutes.patch('/change-password', validate(changePasswordSchema), usersController.changePassword);
